...
const AccommodationPage = () => {
  ...
  const accommodations: Accommodation[] = [
    {
      id: 1,
      name: "Hotel Stâna de Vale",
      description: t('accommodation.hotel1.description'),
      image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
      stars: 3,
      address: "Stâna de Vale, Bihor County, Romania",
      phone: "+40 259 431 881",
      website: "https://stanadevale.ro",
      distance: 0.1,
      features: ["restaurant", "parking", "wifi"],
      price: "€60-90",
    },
    {
      id: 2,
      name: "Vila Vulturilor",
      description: t('accommodation.hotel2.description'),
      image: "https://images.unsplash.com/photo-1614957004131-9e8f2a13573c?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
      stars: 3,
      address: "Stâna de Vale, Bihor County, Romania",
      phone: "+40 744 500 554",
      distance: 0.3,
    ...
    {
      id: 3,
      name: "Cabana Izvorul Minunilor",
      description: t('accommodation.hotel3.description'),
      image: "https://images.unsplash.com/photo-1586982595686-01e1848f9211?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
      stars: 2,
      address: "Stâna de Vale, Bihor County, Romania",
      phone: "+40 722 241 641",
      distance: 0.5,
    ...
    {
      id: 4,
      name: "Pensiunea Stâna de Vale",
      description: t('accommodation.hotel4.description'),
      image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
      stars: 3,
      address: "Stâna de Vale, Bihor County, Romania",
      phone: "+40 359 800 308",
      website: "https://www.pensiuneastanadevale.ro",
      distance: 0.4,
      features: ["restaurant", "parking", "wifi"],
      price: "€55-75",
    },
    {
      id: 5,
      name: "Hotel Metropolis Beiuș",
      description: t('accommodation.hotel5.description'),
      image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
      stars: 4,
      address: "Str. General Moșoiu 30, Beiuș, Bihor County, Romania",
      phone: "+40 359 410 902",
      website: "https://hotelmetropolis.ro",
      distance: 28,
      features: ["restaurant", "parking", "wifi"],
      price: "€70-100",
    },
