              ...
              <div className="space-y-6">
                <Card>
                  <CardContent className="p-6 flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-heading font-semibold text-lg mb-1">{t("contact.info.addressTitle")}</h3>
                ...
                <Card>
                  <CardContent className="p-6 flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-heading font-semibold text-lg mb-1">{t("contact.info.emailTitle")}</h3>
                      <p className="text-neutral-dark">
                        <a href="mailto:info@trailrunpro.com" className="text-[#2E7D32] hover:underline">info@trailrunpro.com</a><br />
                        <a href="mailto:support@trailrunpro.com" className="text-[#2E7D32] hover:underline">support@trailrunpro.com</a>
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="p-6 flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-heading font-semibold text-lg mb-1">{t("contact.info.phoneTitle")}</h3>
                      <p className="text-neutral-dark">
                        <a href="tel:+40123456789" className="text-[#2E7D32] hover:underline">+40 123 456 789</a><br />
                        <a href="tel:+40987654321" className="text-[#2E7D32] hover:underline">+40 987 654 321</a>
                      </p>
                    </div>
                  </CardContent>
                </Card>
