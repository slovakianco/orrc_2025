      ...
      <div className="container mx-auto px-4 py-6 md:py-8 max-w-7xl">
          ...
          <Alert className="mb-6 md:mb-8 bg-[#FFF8E1] border-[#FFB300] text-[#BF6800]">
            <AlertTitle className="flex items-start md:items-center gap-2 text-base md:text-lg font-medium">
              <svg
                ...
                className="text-[#F57F17] mt-0.5 md:mt-0 flex-shrink-0"
              >
            ...
            <AlertDescription className="text-[#BF6800] text-base pl-7 md:pl-8 mt-1">
              {t("howToGet.weatherNote")}
            </AlertDescription>
          </Alert>
        </div>
          ...
          <CardHeader className="p-4 md:p-6">
            <div className="flex items-center gap-2 mb-1 md:mb-2">
              ...
              <CardTitle className="text-lg md:text-2xl">
                {t("howToGet.locationTitle")}
              </CardTitle>
            </div>
            <CardDescription className="text-sm md:text-base">
              {t("howToGet.locationDescription")}
            </CardDescription>
          </CardHeader>
        ...
        <Tabs defaultValue="air" className="mb-10">
          <TabsList className="grid grid-cols-2 gap-2 md:grid-cols-3 mb-6 bg-primary">
            <TabsTrigger
              value="air"
              className="flex items-center gap-1 text-xs md:text-sm text-white data-[state=active]:text-white"
            >
              <Plane className="h-3 w-3 md:h-4 md:w-4" />{" "}
              {t("howToGet.byAir.title")}
            </TabsTrigger>
            <TabsTrigger
              value="car"
              className="flex items-center gap-1 text-xs md:text-sm text-white data-[state=active]:text-white"
              ...
              <CardContent className="p-4 md:p-6 pt-0 md:pt-0">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <Card className="border-2 border-primary/10">
                    <CardHeader className="p-4 md:p-6">
                      <CardTitle className="text-base md:text-lg">
                        {t("howToGet.byAir.oradea.title")}
                      </CardTitle>
                      <CardDescription className="text-sm">
                        {t("howToGet.byAir.oradea.description")}
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="p-4 md:p-6 pt-0 md:pt-0">
                  ...
                  <Card className="border-2 border-primary/10">
                    <CardHeader className="p-4 md:p-6">
                      <CardTitle className="text-base md:text-lg">
                        {t("howToGet.byAir.cluj.title")}
                      </CardTitle>
                      <CardDescription className="text-sm">
                        {t("howToGet.byAir.cluj.description")}
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="p-4 md:p-6 pt-0 md:pt-0">
                      <ul className="space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <CardContent className="p-4 md:p-6 pt-0 md:pt-0">
                      <ul className="space-y-2">
                        ...
                        <li className="flex items-start gap-2 text-sm">
                          ...
                          <span>
                            Connection: Car rental or private transfer
                            recommended
                          </span>
                        </li>
                      </ul>
                  ...
                  <Card className="border-2 border-primary/10">
                    <CardHeader className="p-4 md:p-6">
                      ...
                      <CardDescription className="text-sm">
                        Smaller international airport in eastern Hungary
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="p-4 md:p-6 pt-0 md:pt-0">
                      <ul className="space-y-2">
                        ...
                        <li className="flex items-start gap-2 text-sm">
                          ...
                          <span>
                            Connection: Car rental available at the airport
                          </span>
                        </li>
                      </ul>
                    </CardContent>
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-base md:text-lg font-medium mb-2 md:mb-3">
                      {t("howToGet.byCar.fromOradea.title")}
                    </h3>
                    <p className="mb-2 text-sm md:text-base">
                      {t("howToGet.byCar.fromOradea.description")}
                    </p>
                  ...
                  <div>
                    <h3 className="text-base md:text-lg font-medium mb-2 md:mb-3">
                      {t("howToGet.byCar.fromCluj.title")}
                    </h3>
                    <p className="mb-2 text-sm md:text-base">
                      {t("howToGet.byCar.fromCluj.description")}
                    </p>
                    <ul className="space-y-2 ml-6 list-disc text-sm md:text-base">
                  ...
                  <div className="border-t pt-4">
                    <h3 className="text-base md:text-lg font-medium mb-2 md:mb-3">
                      {t("howToGet.byCar.parking.title")}
                    </h3>
                    <p className="text-sm md:text-base">
                      {t("howToGet.byCar.parking.description")}
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="p-4 md:p-6 pt-0 md:pt-0">
                <div className="space-y-6">
                  <div>
                    <h3 className="text-base md:text-lg font-medium mb-2 md:mb-3">
                      {t("howToGet.byBus.services.title")}
                    </h3>
                    <ul className="space-y-2 ml-6 list-disc text-sm md:text-base">
                  ...
                  <div className="border-t pt-4">
                    <h3 className="text-base md:text-lg font-medium mb-2 md:mb-3">
                      {t("howToGet.byBus.schedules.title")}
                    </h3>
                    <p className="text-sm md:text-base">
                      {t("howToGet.byBus.schedules.description")}
                    </p>
                  </div>
                  ...
                  <div className="bg-primary p-3 md:p-4 rounded-lg mt-4">
                    <p className="text-xs md:text-sm text-white">
                      ...
                      is a useful resource for bus schedules in Romania.
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <div className="mb-10">
          <h2 className="text-xl md:text-2xl font-bold mb-4 flex items-center gap-2 text-primary">
            <CarIcon className="h-5 w-5 md:h-6 md:w-6" />{" "}
            {t("howToGet.localTransport.title")}
          </h2>
          <p className="mb-6 text-sm md:text-base">
            {t("howToGet.localTransport.description")}
          </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                ...
                <Card className="bg-white border-2 border-primary/20">
                  <CardHeader className="p-4">
                    <CardTitle className="text-base font-bold">
                      {t(
                        "howToGet.localTransport.shuttles.toDestination.title",
                      )}
                    </CardTitle>
                  </CardHeader>
                    ...
                    <div className="space-y-3">
                      <div>
                        <p className="font-medium text-primary-dark">
                          {t(
                            "howToGet.localTransport.shuttles.toDestination.friday",
                          )}
                        </p>
                        <p>
                          {t(
                            "howToGet.localTransport.shuttles.toDestination.fridayTimes",
                          )}
                        </p>
                      </div>
                      <div>
                        <p className="font-medium text-primary-dark">
                          {t(
                            "howToGet.localTransport.shuttles.toDestination.saturday",
                          )}
                        </p>
                        <p>
                          {t(
                            "howToGet.localTransport.shuttles.toDestination.saturdayTimes",
                          )}
                        </p>
                      </div>
                    </div>
                ...
                <Card className="bg-white border-2 border-primary/20">
                  <CardHeader className="p-4">
                    <CardTitle className="text-base font-bold">
                      {t(
                        "howToGet.localTransport.shuttles.fromDestination.title",
                      )}
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="p-4 pt-0">
                    <div className="space-y-3">
                      <div>
                        <p className="font-medium text-primary-dark">
                          {t(
                            "howToGet.localTransport.shuttles.fromDestination.friday",
                          )}
                        </p>
                        <p>
                          {t(
                            "howToGet.localTransport.shuttles.fromDestination.fridayTimes",
                          )}
                        </p>
                      </div>
                      <div>
                        <p className="font-medium text-primary-dark">
                          {t(
                            "howToGet.localTransport.shuttles.fromDestination.saturday",
                          )}
                        </p>
                        <p>
                          {t(
                            "howToGet.localTransport.shuttles.fromDestination.saturdayTimes",
                          )}
                        </p>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <Card>
              <CardHeader className="p-4 md:p-6">
                <CardTitle className="text-base md:text-lg">
                  {t("howToGet.localTransport.taxis.title")}
                </CardTitle>
              </CardHeader>
              <CardContent className="p-4 md:p-6 pt-0 md:pt-0">
                <p className="text-sm md:text-base">
                  {t("howToGet.localTransport.taxis.description")}
                </p>
              </CardContent>
            </Card>
          </div>
