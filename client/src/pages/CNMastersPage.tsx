      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 md:p-8 mb-10">
          ...
          <p className="mt-6 text-sm text-neutral-dark/80">
            Notă: Vârsta se calculează conform regulamentelor FRA pentru
            competițiile de alergare montană Masters.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 md:p-8 mb-10">
          ...
          <ul className="list-disc list-inside space-y-3 text-neutral-dark">
            <li>
              Campionatul Naţional Masters de Alergare Montană se desfășoară în
              cadrul competiției Stana de Vale Trail Race.
            </li>
            <li>
              Participanții trebuie să aibă vârsta de minim 35 de ani împliniți
              la data competiției.
            </li>
            <li>
              Cursele se desfășoară conform regulamentului general al
              competiției și regulamentelor FRA.
            </li>
            <li>
              Participanții la Campionatul Naţional Masters vor fi clasați și în
              clasamentul general al competiției.
            </li>
            <li>
              Premiile pentru Campionatul Naţional Masters vor fi acordate în
              cadrul ceremoniei de premiere.
            </li>
          </ul>
        </div>
          ...
          <div className="flex flex-col gap-6">
            <div className="w-full">
              <h3 className="font-bold text-lg mb-2">
                Comisia de Atletism Masters
              </h3>
              <p className="text-neutral-dark mb-4">
                Comisia de Atletism Masters coordonează activitatea atletică
                pentru sportivii Masters (35+ ani) din România, organizând
                campionate naționale pentru diverse probe, inclusiv alergare
                montană. Competițiile se desfășoară conform regulamentelor
                internaționale WMA (World Masters Athletics).
              </p>
              ...
              <div className="flex flex-col space-y-2 text-sm">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-neutral-dark">
                    <a
                      href="https://www.facebook.com/RomanianMastersAthletics/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-primary hover:underline"
                    >
