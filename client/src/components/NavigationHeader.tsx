...
const NavigationHeader = () => {
  ...
  const navItems: NavItem[] = [
    ...
    { label: t('nav.registration'), path: "/registration", isActive: location === "/registration" },
    { label: t('nav.participants'), path: "/participants", isActive: location === "/participants" },
    { label: t('nav.rules'), path: "/rules", isActive: location === "/rules" },
    { label: t('nav.program'), path: "/program", isActive: location === "/program" },
    { label: t('nav.contact'), path: "/contact", isActive: location === "/contact" },
    { label: t('nav.sponsors'), path: "/sponsors", isActive: location === "/sponsors" },
  ];
